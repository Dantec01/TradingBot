...
class TradingEngine {
    constructor(config) {
        ...
        // eliteTickOffset: Price offset for Breakeven+Tick SL (default: 0.0001)
            ...
            if (isTrigger || isSpiritReEntry) {
                ...
                if (canEnter) {
                    ...
                    if (this.strategy === 'BACKGUARD') {
                        ...
                        // SPIRIT_ELITE & SPIRIT_TRAILING: Aggressive Limit Order (+0.5% offset)
                        ...
                        this.log('INFO', `${this.strategy} - Placing Aggressive Limit ${type} at ${limitPrice.toFixed(4)} (base: ${targetPrice})`);
                        await this.placeLimitOrder(type, limitPrice, candle.time, 0, true); // isElite = true for both
                    } else {
