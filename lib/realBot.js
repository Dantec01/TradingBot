...
class TradingEngine {
    ...
    async closePosition(price, reason) {
        ...
        try {
            ...
            // Use 5 decimals for low-price coins
            const decimals = this.position.entryPrice < 1 ? 5 : 4;
            ...
            this.log('INFO', `📊 Entry: ${this.position.entryPrice.toFixed(decimals)} | Exit: ${exitPrice.toFixed(decimals)} | Diff: ${((exitPrice - this.position.entryPrice) * (this.position.type === 'LONG' ? 1 : -1)).toFixed(decimals)}`);
