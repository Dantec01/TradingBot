...
class TradingEngine {
    ...
    manageOpenPosition(tick) {
        ...
        // ============================================================
        // SPIRIT_TEST: Real-time Trailing (tick-by-tick, like Binance native)
        // Updates extremes and recalculates trailing SL on EVERY tick
        // ============================================================
        if (this.strategy === 'SPIRIT_TEST' && this.slMode === 'TRAILING') {
            // Update extremes on every tick (real-time)
            ...
            // Recalculate trailing SL on every tick
            ...
            // Check hit only AFTER entry candle
