        ...
        if (!position && !pendingLimit) {
            ...
            if (candle.isTrigger && ((candle.signalStr === 'Buy' && canLong) || (candle.signalStr === 'Sell' && canShort))) {
                ...
                if (strategy === 'BACKGUARD') {
                    ...
                    if (strategy === 'CLOSE_ENTRY' || strategy === 'SPIRIT' || strategy === 'SPIRIT_IMPROVED' || strategy === 'SPIRIT_TRAILING' || strategy === 'SPIRIT_EXPERIMENTAL' || strategy === 'SPIRIT_EXPERIMENTAL_FIXED' || strategy === 'SPIRIT_ELITE') {
