...
class BotManager {
    ...
    handleOrderTradeUpdate(order) {
        ...
        const orderType = order.o; // Order type from WebSocket: STOP_MARKET, TRAILING_STOP_MARKET, etc.
        const isStopMatch = engine.activeStopOrder && (
            engine.activeStopOrder.orderId === orderId ||
            (engine.activeStopOrder.orderId === null && (orderType === 'TRAILING_STOP_MARKET' || orderType === 'STOP_MARKET' || orderType === 'TAKE_PROFIT_MARKET'))
        );
